    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4">
      <div className="auth-card">
        <input
          ...
          type="checkbox"
          id="blind-input-register"
          checked={showPassword}
          onChange={(e) => setShowPassword(e.target.checked)}
          hidden
        />

        <label htmlFor="blind-input-register" className="blind_input">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <label className="label_input" htmlFor="email-input-register">
            Email
          </label>
          <input
            spellCheck="false"
          ...
          <label className="label_input" htmlFor="password-input-register">
            Password
          </label>
          <input
            spellCheck="false"
